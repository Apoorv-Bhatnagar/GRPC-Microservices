...
public final class notificationGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.globallogic.slotBooking.Notification.notificationMessage,
      com.globallogic.slotBooking.Notification.APIResponse> getRegisterNotificationMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "registerNotification",
      requestType = com.globallogic.slotBooking.Notification.notificationMessage.class,
      responseType = com.globallogic.slotBooking.Notification.APIResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.globallogic.slotBooking.Notification.notificationMessage,
      com.globallogic.slotBooking.Notification.APIResponse> getRegisterNotificationMethod() {
    io.grpc.MethodDescriptor<com.globallogic.slotBooking.Notification.notificationMessage, com.globallogic.slotBooking.Notification.APIResponse> getRegisterNotificationMethod;
      ...
      synchronized (notificationGrpc.class) {
        if ((getRegisterNotificationMethod = notificationGrpc.getRegisterNotificationMethod) == null) {
          notificationGrpc.getRegisterNotificationMethod = getRegisterNotificationMethod = 
              io.grpc.MethodDescriptor.<com.globallogic.slotBooking.Notification.notificationMessage, com.globallogic.slotBooking.Notification.APIResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "notification", "registerNotification"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.globallogic.slotBooking.Notification.notificationMessage.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.globallogic.slotBooking.Notification.APIResponse.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<com.globallogic.slotBooking.Notification.otpMessage,
      com.globallogic.slotBooking.Notification.APIResponse> getSendOtpMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "sendOtp",
      requestType = com.globallogic.slotBooking.Notification.otpMessage.class,
      responseType = com.globallogic.slotBooking.Notification.APIResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.globallogic.slotBooking.Notification.otpMessage,
      com.globallogic.slotBooking.Notification.APIResponse> getSendOtpMethod() {
    io.grpc.MethodDescriptor<com.globallogic.slotBooking.Notification.otpMessage, com.globallogic.slotBooking.Notification.APIResponse> getSendOtpMethod;
    if ((getSendOtpMethod = notificationGrpc.getSendOtpMethod) == null) {
      synchronized (notificationGrpc.class) {
        if ((getSendOtpMethod = notificationGrpc.getSendOtpMethod) == null) {
          notificationGrpc.getSendOtpMethod = getSendOtpMethod = 
              io.grpc.MethodDescriptor.<com.globallogic.slotBooking.Notification.otpMessage, com.globallogic.slotBooking.Notification.APIResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "notification", "sendOtp"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.globallogic.slotBooking.Notification.otpMessage.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.globallogic.slotBooking.Notification.APIResponse.getDefaultInstance()))
  ...
  public static abstract class notificationImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void registerNotification(com.globallogic.slotBooking.Notification.notificationMessage request,
        io.grpc.stub.StreamObserver<com.globallogic.slotBooking.Notification.APIResponse> responseObserver) {
      asyncUnimplementedUnaryCall(getRegisterNotificationMethod(), responseObserver);
    }

    /**
     */
    public void sendOtp(com.globallogic.slotBooking.Notification.otpMessage request,
        io.grpc.stub.StreamObserver<com.globallogic.slotBooking.Notification.APIResponse> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                com.globallogic.slotBooking.Notification.notificationMessage,
                com.globallogic.slotBooking.Notification.APIResponse>(
                  this, METHODID_REGISTER_NOTIFICATION)))
          .addMethod(
            getSendOtpMethod(),
            asyncUnaryCall(
              new MethodHandlers<
                com.globallogic.slotBooking.Notification.otpMessage,
                com.globallogic.slotBooking.Notification.APIResponse>(
  ...
  public static final class notificationBlockingStub extends io.grpc.stub.AbstractStub<notificationBlockingStub> {
    ...
    /**
     */
    public com.globallogic.slotBooking.Notification.APIResponse registerNotification(com.globallogic.slotBooking.Notification.notificationMessage request) {
    ...
    /**
     */
    public com.globallogic.slotBooking.Notification.APIResponse sendOtp(com.globallogic.slotBooking.Notification.otpMessage request) {
      return blockingUnaryCall(
  ...
  public static final class notificationFutureStub extends io.grpc.stub.AbstractStub<notificationFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.globallogic.slotBooking.Notification.APIResponse> registerNotification(
        com.globallogic.slotBooking.Notification.notificationMessage request) {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.globallogic.slotBooking.Notification.APIResponse> sendOtp(
        com.globallogic.slotBooking.Notification.otpMessage request) {
      return futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_REGISTER_NOTIFICATION:
          serviceImpl.registerNotification((com.globallogic.slotBooking.Notification.notificationMessage) request,
              (io.grpc.stub.StreamObserver<com.globallogic.slotBooking.Notification.APIResponse>) responseObserver);
          break;
        case METHODID_SEND_OTP:
          serviceImpl.sendOtp((com.globallogic.slotBooking.Notification.otpMessage) request,
              (io.grpc.stub.StreamObserver<com.globallogic.slotBooking.Notification.APIResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class notificationBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.globallogic.slotBooking.Notification.getDescriptor();
    }
